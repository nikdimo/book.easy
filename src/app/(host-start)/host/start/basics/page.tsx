...
export default async function BasicsPage({ searchParams }: { searchParams: Promise<ListingFlowSearchParams> }) {
  ...
  return <div className="listing-flow flex min-h-dvh flex-col bg-white text-slate-950 md:h-dvh md:overflow-hidden"><NewListingHeader t={t} exitHref="/host/listings" /><BasicsStep propertyType={propertyType} spaceType={spaceType} /></div>;
}
