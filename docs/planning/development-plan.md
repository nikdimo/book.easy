# Linger Homes — Development Plan

## Overview

This document outlines the phased development plan for Linger Homes, a two-sided property marketplace. The plan is structured to deliver a launchable MVP in Phase 1, then expand toward full marketplace functionality in subsequent phases.
...
- Export Linger Homes calendar for use in other platforms
