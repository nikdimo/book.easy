...
export default async function PropertyDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <EditorFrame listingId={id} section="rooms" attention={header.attention} overview={header} previewSlug={header.slug} previewStatus={header.status}><PropertyDetailsWorkspace listingId={id} stored={details.stored} propertyTypes={details.propertyTypes} rooms={details.rooms} roomTypes={details.roomTypes} countedTypes={details.countedTypes} /></EditorFrame>;
}
