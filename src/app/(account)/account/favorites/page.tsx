...
export default async function MyFavoritesPage() {
  ...
  if (listings.length === 0) {
    return (
      <div>
        <h1 className="text-2xl font-bold mb-6"><T t={t} k="account.favorites.heading" source="My Favorites" /></h1>
        <EmptyState
          icon={Heart}
          title={text(t, "account.favorites.empty_title", "No favorites yet")}
          description={text(t, "account.favorites.empty_description", "Tap the heart on any listing to save it here.")}
        >
          <Button asChild>
