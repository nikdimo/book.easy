...
import { parseCalendarListingParam } from "@/lib/host/v2/calendar-href";
...
export default async function HostV2CalendarPage({
  ...
  // Anything that could not be an id is dropped before it reaches the workspace, so a
  // crafted or repeated parameter never decides what the calendar renders.
