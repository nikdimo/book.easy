...
echo Starting Linger Homes dev server...
start "Linger Homes dev" /D "%~dp0" cmd /k npm run dev
...
echo Close the other window titled "Linger Homes dev" to stop the server.
echo.
pause
